...
define( 'REN_VERSION', '2.76.1' ); // Keep in sync with the "Version:" header in style.css on every release — this drives cache-busting for every enqueued script/style.
...
require_once REN_DIR . '/inc/navigation-menus.php';
require_once REN_DIR . '/inc/archive-view.php';
require_once REN_DIR . '/inc/experience-timeline.php';
